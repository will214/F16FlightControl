###########################################################################
## Makefile generated for Simulink model 'SS_F16_Block'. 
## 
## Makefile     : SS_F16_Block.mk
## Generated on : Sun Nov 25 16:31:03 2018
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SS_F16_Block
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/lorenzoterenzi/Documents/Aerospace_msc/AE4301-Automatic_flight/automatic_flight_assignment/F16Sim
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SS_F16_Block
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/SS_F16_Block_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=SS_F16_Block -DNUMST=2 -DNCSTATES=18 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/SS_F16_Block_grt_rtw/SS_F16_Block.c $(START_DIR)/SS_F16_Block_grt_rtw/SS_F16_Block_data.c $(START_DIR)/SS_F16_Block_grt_rtw/rtGetInf.c $(START_DIR)/SS_F16_Block_grt_rtw/rtGetNaN.c $(START_DIR)/SS_F16_Block_grt_rtw/rt_nonfinite.c rt_sim.c $(MATLAB_ROOT)/rtw/c/grt/classic_main.c
...
OBJS = rt_logging.o SS_F16_Block.o SS_F16_Block_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o classic_main.o
...
%.o : $(START_DIR)/SS_F16_Block_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SS_F16_Block_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
